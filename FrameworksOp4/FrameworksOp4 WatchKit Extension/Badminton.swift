...
class Badminton: WKInterfaceController {
    ...
    @IBAction func add_local1(){
        ...
        // Si coneguimos 21 puntos y tenemos una ventaja de 2 puntos, hemos ganado el set
        if (puntoLocal >= 21 && ventajaDe2 >= 2){
            puntoLocal = 0
            setLocal = setLocal + 1
    ...
    @IBAction func add_visitante1(){
        ...
        if (puntoVisitante >= 21 && ventajaDe2 >= 2){
            puntoVisitante = 0
